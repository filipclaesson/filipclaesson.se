...
plotChartDate('quarter','round' ,'Tkr', 'Prisutveckling per stadsdel (Tkr/sqm)', "price_development_absolute", "select area_from_geo as areas , month as quarter , round(avg(sqm_sold_price)) as round from booli.analysis_base where sqm between 40 and 80 and area_from_geo <> 'Odefinierad' group by 1,2 ")
